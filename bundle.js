...
},{"./scripts/add_to_list":3,"./scripts/bubbles":4,"./scripts/cost_calculation":5,"./scripts/get_recipe":8,"./scripts/nutrition_api":9}],2:[function(require,module,exports){
'use strict';
...
var british_cuisine = ["Full English Breakfast",
// "Eggs Benedict",
"Beans on Toast", "Porridge", "Kippers", "Black Pudding", "Crumpets", "Bacon Sandwich (Bacon Butty)", "Bubble and Squeak", "Smoked Salmon & Scrambled Eggs", "Ploughman’s Lunch", "Fish and Chips", "Cornish Pasty", "Scotch Egg", "Sausage Roll", "Welsh Rarebit", "Jacket Potato", "Chicken and Leek Pie", "Cottage Pie", "Prawn Cocktail", "Roast Beef and Yorkshire Pudding", "Shepherd’s Pie", "Beef Wellington", "Toad in the Hole", "Lamb Shank with Mint Sauce", "Steak and Ale Pie", "Bangers and Mash", "Chicken Tikka Masala", "Fish Pie", "Eton Mess", "Sticky Toffee Pudding", "Bread and Butter Pudding", "Trifle", "Victoria Sponge Cake", "Bakewell Tart", "Spotted Dick", "Apple Crumble", "Banoffee Pie", "Treacle Tart", "Scones with Clotted Cream and Jam"];
...
function updateIngredientsList(fullRecipeText) {
  ...
  var startIndex = fullRecipeText.indexOf("Ingredients:");
  var endIndex = fullRecipeText.indexOf("Recipe:");
  ...
  var ingredientsBlock = fullRecipeText.substring(startIndex + "Ingredients:".length, endIndex).trim();
  var ingredientLines = ingredientsBlock.split('- ');
  var ingredientsFound = 0;
  var _iterator = _createForOfIteratorHelper(ingredientLines),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (trimmedLine) {
        console.log("trimmedLine ".concat(trimmedLine));
        ingredientsFound++;
...
},{"./get_recipe.js":8}],4:[function(require,module,exports){
"use strict";
...
},{"./costs.json":6}],6:[function(require,module,exports){
module.exports={
...
},{"@google/generative-ai":2}],8:[function(require,module,exports){
"use strict";
...
function _show_recipe() {
  _show_recipe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var text, ingredientDisplay, recipeDisplay, title, prompt, recipe, recipeHtml, parts;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          text = "";
...
},{"./gemini.js":7}],9:[function(require,module,exports){
"use strict";
