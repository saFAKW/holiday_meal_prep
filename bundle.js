...
},{"./scripts/add_to_list":3,"./scripts/cost_calculation":4,"./scripts/get_recipe":7,"./scripts/nutrition_api":8}],2:[function(require,module,exports){
'use strict';
...
function add_ingredients_to_list() {
  var recipeButton = document.getElementById("add-to-basket");
  var recipeText = document.getElementById("recipe-p");
  recipeButton.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          button.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 4:
                  prompt = "Please provide a simple recipe for ".concat(input.value.trim(), " ").concat(PROMPT);
                  _context.next = 7;
